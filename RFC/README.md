...
Request for Comments provides a structured review process for proposed changes to the normative APS specification.
...
|----------|-------------|
| `NNNN-short-title.md` | Individual RFC documents with motivation, design, compatibility analysis, and review status |
